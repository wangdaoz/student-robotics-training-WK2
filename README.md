## Purpose
     1. the student-robotics-training-WK2
     2. Build Your First Distributed Robotics Software
     3. Build a Reusable ROS 2 Onboarding Example
...
├── docs/
│   ├── ros2_setup.md
|   ├── ros2_1stpackage_setup.md
|   ├── pub_sub_setup.md
│   ├── ros2_architecture.md
|   ├── ros2_package_structure.md
|   ├── Milestone2.5_troubleshooting.md
  ...
  ### Build Package "student_robotics"
   1. Make sure you're inside your workspace's "src" directory
      '''
       cd ~/robot_ws/src
      '''
       Note: If robot_ws/src doesn't exist yet, create it first: <mkdir -p ~/robot_ws/src && cd ~/robot_ws/src>
 ...
 ### Add a minimal node executable and run it through ROS 2
   ...
   5.
      '''
       source install/setup.bash
      '''
  Task 2. Build Your First Distributed Robotics Software
          ...
          ● 
           ...
           ● run Publisher file in first terminal
            '''
             ros2 run student_robotics status_publisher
            '''
           ● run Subscriber file in next terminal
            '''
             ros2 run student_robotics status_subscriber
            '''

           ● Input Inspection commands in the remind terminal
             '''
              ros2 topic list
             ...
             '''
   Task 3. Build a Reusable ROS 2 Onboarding Example
      Subtasks
             ...
             Suppose you want to make both publish rate and topic name configurable:
               ...
               1. modify codes in "status_publisher_stretch.py"
                   add the following codes:
                     ...
                     '''
                 Add the segment of codes above after the following codes:
                          '''
        ...
        #5 Add a verification script
            # script
              ...
              '''
                touch ~/student-robotics-training-WK2/tests/verify_demo.sh
              '''
...
## Running Examples
     ...
     Task 2:
         robot_ws/src/student_robotics/student_robotics/status_publisher_stretch.py
         robot_ws/src/student_robotics/student_robotics/status_subscriber.py

     Task 3:
         1. robot_ws/src/student_robotics/launch/status_demo.launch.py
...
## Testing
   ...
   Task 2. Build Your First Distributed Robotics Software
            refer the file:
            ~\student-robotics-training-WK2/tests/test.md
   ...
   SubTask 2:
            ...
            2. in a new terminal:
                     '''
                       ...
                       ros2 topic hz /robot_status_test 
                       
                       ros2 topic echo /robot_status_test
                     '''
              Expecetd Results:
...
## Current Status
    After task 1, package build/, install/, log/, src/ were created in "student-robotics-training-WK2/robot_ws/" directory
   ...
   After task 2, inside the package: student_robotics,
                             student_robotics/
                                    ├── package.xml
                                    ├── setup.py
                                    ├── setup.cfg
